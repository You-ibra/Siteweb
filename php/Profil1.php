...
<html>
  ...
  <body >
    ...
    <div id="principal" >
      <label id="label_profil">Etat du profil :</label>
      <img id="etat" name="etat" src="../img/etat.png" alt="logo de monnaie" />
        <div id="informations">
          <img id="profil" name="profil" src="../img/profil.png" alt="logo du profil" />
          <img id="beps" name="beps" src="../img/beps.png" alt="logo de monnaie" />
          <input type="text" id="nbbeps" value="100">
            <div id="partie1">
                <div id="nomuser">
                    <label id="label_utilisateur">Nom d'utilisateur</label>
                </div>
                <div id="nom">
                    <label id="label_prenom">Nom</label>
                    <input type="text" size="40" pattern="[A-Za-zÀ-ÿ ]+" id="nom" name="nom_contact" required>
                    <label id="label_prenom">Prénom</label>
                    <input type="text" size="40" pattern="[A-Za-zÀ-ÿ ]+" id="prenom" name="nom_contact" required>

                </div>
                <div id="mail">
                    <label id="label_mail">Mail</label>
                    <input type="email" size="40" pattern="[a-zA-Z0-9._-]+@[a-zA-Z0-9._-]+.[a-zA-Z.]{2,15}" name="email_contact" id="email" required>
                </div>
                <div id="date">
            ...
            <div id="partie2">
                ...
                <label id="adresse">Adresse complète :</label>
